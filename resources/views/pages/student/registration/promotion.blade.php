        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h2 class="card-title">Promotion Student</h2>
              <a href="{{ route('student.reg.view') }}"><h4 class="btn btn-sm btn-success float-right"><i class="fa fa-list">All Registration</i></h4></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('student.reg.promotion.update',$student->student_id) }}" method="POST" id="myform" enctype="multipart/form-data">
                @csrf
             <div class="row">
            ...
            <div class="card-footer">
                  <button type="submit" class="btn btn-primary btn-sm">Promotion</button>
            </div>
            </div>
          </form>
          </div>
