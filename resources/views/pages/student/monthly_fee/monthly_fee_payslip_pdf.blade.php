	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<h5 style="font-weight: bold; padding-top: -25px;">Monthly Fee Pay Slip</h5>
			</div>

			<div class="col-md-12">
				@php

					$registrationFee = App\Model\FeeCategoryAmount::where('fee_category_id',4)->where('student_class_id',$detail->class_id)->first();
				...
				<table border="1" width="100%">
					...
					<tr>
						<td width="50%">Fee (This Student) of {{ $month }}</td>
						<td>{{$finalFee}} Tk</td>
					</tr>
