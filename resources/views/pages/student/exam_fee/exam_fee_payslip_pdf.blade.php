		...
		<div class="row">
			...
			<div class="col-md-12">
				@php
					...
					$registrationFee = App\Model\FeeCategoryAmount::where('fee_category_id',3)->where('student_class_id',$detail->class_id)->first();
				...
				<table border="1" width="100%">
					...
					<tr>
						<td width="50%">Fee (This Student) of {{ $exam }}</td>
						<td>{{$finalFee}} Tk</td>
					</tr>
